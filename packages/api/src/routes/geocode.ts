...
const CITIES: CityRecord[] = [
  ...
  {
    place_name: 'Denver, USA',
    lat: 39.7392, lon: -104.9903,
    timezone: 'America/Denver', utc_offset_hours: -7,
    bbox: [39.5, 40.0, -105.1, -104.8],
    aliases: ['denver'],
  },
  {
    place_name: 'Phoenix, USA',
    lat: 33.4484, lon: -112.0740,
    timezone: 'America/Phoenix', utc_offset_hours: -7,
    bbox: [33.2, 33.8, -112.3, -111.8],
    aliases: ['phoenix'],
  },
  {
    ...
    timezone: 'America/New_York', utc_offset_hours: -5,
    bbox: [33.6, 34.0, -84.5, -84.2],
    aliases: ['atlanta'],
  },
  {
    place_name: 'Miami, USA',
    lat: 25.7617, lon: -80.1918,
    timezone: 'America/New_York', utc_offset_hours: -5,
    bbox: [25.6, 26.0, -80.3, -80.1],
    aliases: ['miami'],
  },
  {
    place_name: 'Dallas, USA',
    lat: 32.7767, lon: -96.7970,
    timezone: 'America/Chicago', utc_offset_hours: -6,
    bbox: [32.6, 33.0, -97.0, -96.6],
    aliases: ['dallas'],
  },
  {
    place_name: 'San Jose, USA',
    lat: 37.3382, lon: -121.8863,
    timezone: 'America/Los_Angeles', utc_offset_hours: -8,
    bbox: [37.2, 37.5, -122.1, -121.7],
    aliases: ['san jose'],
  },
  {
    place_name: 'Portland, USA',
    lat: 45.5152, lon: -122.6784,
    timezone: 'America/Los_Angeles', utc_offset_hours: -8,
    bbox: [45.4, 45.6, -122.8, -122.5],
    aliases: ['portland'],
  },
  {
    place_name: 'Austin, USA',
    lat: 30.2672, lon: -97.7431,
    timezone: 'America/Chicago', utc_offset_hours: -6,
    bbox: [30.1, 30.5, -97.9, -97.6],
    aliases: ['austin'],
  },
  {
